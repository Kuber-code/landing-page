...
area: 1 ha
status: Built
team: Collaboration with architectural office
name:
...
description:
  en:
    ...
    - The repeated geometry gives the park a single visual language while letting each module take a different role, from quiet shaded benches to active play structures.
  pl:
